...
const register = async (req, res) => {
  try {
    ...
    const verificationUrl = `${process.env.EMAIL_VERIFICATION_LINK}/verify-email?token=${emailToken}&email=${user.email}`;
...
const forgotPassword = async (req, res) => {
  try {
    ...
    const resetUrl = `${process.env.EMAIL_VERIFICATION_LINK}/reset-password/${resetToken}`;
