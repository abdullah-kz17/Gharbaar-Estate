  ...
  return (
      <div className="min-h-screen flex items-center justify-center px-4 bg-white dark:bg-gray-900 transition-colors">
        <div className="w-full max-w-md bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-100 shadow-2xl rounded-xl p-8">
          <h2 className="text-3xl font-bold text-center text-indigo-600 dark:text-indigo-300 mb-2">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <input
                  ...
                  className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:bg-gray-900 dark:text-gray-100"
              />
            </div>
          ...
          <p className="mt-6 text-center text-sm text-gray-600 dark:text-gray-300">
            ...
            <Link to="/login" className="text-indigo-600 dark:text-indigo-300 hover:underline font-medium">
              Go back to login
            </Link>
          </p>
        </div>
